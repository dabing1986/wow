isboxer.Character.Name = "替补二-辛迪加";
isboxer.Character.ActualName = "替补二";
isboxer.Character.QualifiedName = "替补二-辛迪加";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="替补飞机") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite 替补一\n/invite 替补三\n",nil,nil,nil,1);
...
isboxer.Output("Character '替补二-辛迪加' activated");
