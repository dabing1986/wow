isboxer.Character.Name = "肖恩丶狂暴者-辛迪加";
isboxer.Character.ActualName = "肖恩丶狂暴者";
isboxer.Character.QualifiedName = "肖恩丶狂暴者-辛迪加";
...
isboxer.Output("Character '肖恩丶狂暴者-辛迪加' activated");
