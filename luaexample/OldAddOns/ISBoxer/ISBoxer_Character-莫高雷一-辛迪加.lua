isboxer.Character.Name = "莫高雷一-辛迪加";
isboxer.Character.ActualName = "莫高雷一";
isboxer.Character.QualifiedName = "莫高雷一-辛迪加";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="莫高雷飞机") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite 莫高雷二\n/invite 莫高雷三\n",nil,nil,nil,1);
...
isboxer.Output("Character '莫高雷一-辛迪加' activated");
