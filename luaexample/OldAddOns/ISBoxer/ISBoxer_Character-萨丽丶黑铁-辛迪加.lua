isboxer.Character.Name = "萨丽丶黑铁-辛迪加";
isboxer.Character.ActualName = "萨丽丶黑铁";
isboxer.Character.QualifiedName = "萨丽丶黑铁-辛迪加";

function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="站站贼") then
		isboxer.SetMacro("FTLAssist","BACKSPACE","/assist [nomod:alt,mod:lshift,nomod:ctrl]萨丽丶黑铁;[nomod:alt,mod:rshift,nomod:ctrl]塞卡丽;[nomod:alt,nomod:shift,mod:lctrl]肖恩丶狂暴者\n",1,1,1,1);

		isboxer.SetMacro("FTLFocus","NONE","/focus [nomod:alt,mod:lshift,nomod:ctrl]萨丽丶黑铁;[nomod:alt,mod:rshift,nomod:ctrl]塞卡丽;[nomod:alt,nomod:shift,mod:lctrl]肖恩丶狂暴者\n",1,1,1,1);

		isboxer.SetMacro("FTLFollow","F11","/jamba-follow snw\n/follow [nomod:alt,mod:lshift,nomod:ctrl]萨丽丶黑铁;[nomod:alt,mod:rshift,nomod:ctrl]塞卡丽;[nomod:alt,nomod:shift,mod:lctrl]肖恩丶狂暴者\n",1,1,1,1);

		isboxer.SetMacro("FTLTarget","]","/targetexact [nomod:alt,mod:lshift,nomod:ctrl]萨丽丶黑铁;[nomod:alt,mod:rshift,nomod:ctrl]塞卡丽;[nomod:alt,nomod:shift,mod:lctrl]肖恩丶狂暴者\n",1,1,1,1);

		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite 塞卡丽\n/invite 肖恩丶狂暴者\n",nil,nil,nil,1);
...
isboxer.Output("Character '萨丽丶黑铁-辛迪加' activated");
