isboxer.Character.Name = "赞达二-辛迪加";
isboxer.Character.ActualName = "赞达二";
isboxer.Character.QualifiedName = "赞达二-辛迪加";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="赞达拉飞机") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite 赞达一\n/invite 赞达三\n",nil,nil,nil,1);
...
isboxer.Output("Character '赞达二-辛迪加' activated");
