isboxer.Character.Name = "风歌花一-辛迪加";
isboxer.Character.ActualName = "风歌花一";
isboxer.Character.QualifiedName = "风歌花一-辛迪加";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="风歌") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite 风歌花二\n/invite 风歌花三\n",nil,nil,nil,1);
...
isboxer.Output("Character '风歌花一-辛迪加' activated");
