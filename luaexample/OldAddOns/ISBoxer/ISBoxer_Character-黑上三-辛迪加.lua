isboxer.Character.Name = "黑上三-辛迪加";
isboxer.Character.ActualName = "黑上三";
isboxer.Character.QualifiedName = "黑上三-辛迪加";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="黑上飞机") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite 黑上一\n/invite 黑上二\n",nil,nil,nil,1);
...
isboxer.Output("Character '黑上三-辛迪加' activated");
