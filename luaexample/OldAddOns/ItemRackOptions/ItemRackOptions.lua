...
ItemRack.CheckButtonLabels = {
	...
	["ItemRackOptEventEditBuffNotInPVEText"] = "副本除外",
	["ItemRackOptEventEditStanceUnequipText"] = "切换姿态还原",
	["ItemRackOptEventEditZoneUnequipText"] = "切换区域还原",
...
function ItemRackOpt.OnLoad(self)
	...
	ItemRackOpt.OptInfo = {
		...
		{type="check",optset=ItemRackUser,variable="EnablePerSetQueues",depend="EnableQueues",label="启用独立序列",tooltip="为每一个套装启用独立自动序列。"},
