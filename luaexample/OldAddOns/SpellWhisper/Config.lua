--版本控制：1.9.3 新增TradeLog、VersionCheck功能
...
function Panel:Initialize()
	...
	local DeleteAllLog = self:CreateButton(L["Delete All"],
		function(self)
			...
			print(L["<|cFFBA55D3TL|r>All Trade Logs was deleted!"])
		end)
	...
	--交易管理
	TradeModeTitle:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 0, -400)
	TradeLogSwitch:SetPoint("TOPLEFT", TradeModeTitle, "BOTTOMLEFT", 30, -15)
	SendToGroupCheckBox:SetPoint("LEFT", TradeLogSwitch, "LEFT", 210, 0)
	TradeLogDayHeading:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 30, -480)
	TradeLogDays:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", TradeLogDayHeading:GetStringWidth() + 60, -480)
	PrintTradeLog:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 350, -465)
	DeleteAllLog:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 350, -495)
	--战场自动报告
	BGWarningHeading:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 0, -530)
	BGWarningSwitch:SetPoint("TOPLEFT", BGWarningHeading, "BOTTOMLEFT", 30, -15)
	--密语跟随
	FollowHeading:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 0, -600)
	...
	--监控法术类型菜单
	SpellListHeading:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 0, -740)
	DisplaySpellType:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 110, -770)
	DisplaySpellButton:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 280, -770)
	RestoreButton:SetPoint("TOPLEFT", AddonSwitch, "BOTTOMLEFT", 340, -770)
	...
	if GetCVar("portal") == "CN" then
		PreventRobotTradeTitle:SetPoint("LEFT", TradeModeTitle, "LEFT", 380, 0)
		PreventRobotTradeSwitch:SetPoint("LEFT", TradeLogSwitch, "LEFT", 380, 0)
	end
end
